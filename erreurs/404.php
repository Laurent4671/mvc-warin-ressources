  ...
  <body class="hold-transition skin-blue layout-boxed">
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <!-- Logo -->
        <a href="index.php?p=login" class="logo">
      ...
      <aside class="main-sidebar">
		...
		?>
          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview<?php if ($page == 'admin_categories_liste' || $page == 'admin_sous_categs_liste'){echo ' active';} ?>">
				...
				<ul class="treeview-menu">
					...
					<li<?php if ($page == 'admin_sous_categs_liste'){echo ' class="active"';} ?>><a href="index.php?p=admin_sous_categs"><i class="fa fa-circle-o text-red"></i> Sous-catégories</a></li>
					<li><a href="#"><i class="fa fa-circle-o text-aqua"></i> Liens ajoutés</a></li>
				</ul>
			</li>
		...
		<section class="content">
          <div class="error-page">
            ...
            <div class="error-content">
              ...
              <p>Une erreur s'est produite et la page à laquelle vous tentez d'accéder ne peut pas s'afficher.</p>
            </div><!-- /.error-content -->
          </div><!-- /.error-page -->
        </section><!-- /.content -->
